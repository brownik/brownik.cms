...
생성일: 2016-09-26 14:05:54
수정일: 2017-04-03 11:51:43
*/
...
$(document).ready(function(){
  ...
  $("#aFourText").click(function(){
    $("#fourLine").attr("class", "on");
    fourLine = $("#fourLine").offset();
    $('html, body').animate({
      scrollTop: fourLine.top-lineRevision
    }, 300)
  });
  $("#aFiveText").click(function(){
    $("#fiveLine").attr("class", "on");
    fiveLine = $("#fiveLine").offset();
    $('html, body').animate({
      scrollTop: fiveLine.top-lineRevision
    }, 300)
  });
