...
@Data
public class BoardItemCreateRequest {
    ...
    private String notice; // Y=공지사항, N=일반 (기본값: N)

    @Pattern(regexp = "^[YN]?$", message = "비밀글 여부는 Y 또는 N만 가능합니다")
    private String secret; // Y=비밀글, N=일반 (기본값: N)
    ...
    private Long parentKey; // 답글인 경우 부모 게시글 키
}
